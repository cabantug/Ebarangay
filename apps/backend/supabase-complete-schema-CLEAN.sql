...
CREATE POLICY "Only admins can read registration requests" ON registration_requests FOR SELECT USING (true);
CREATE POLICY "Anyone can create registration requests" ON registration_requests FOR INSERT WITH CHECK (true);
CREATE POLICY "Only admins can approve registration requests" ON registration_requests FOR UPDATE USING (true);
...
CREATE POLICY "Admins can manage all certifications" ON certifications FOR ALL USING (true);
...
CREATE POLICY "Admins can manage all complaints" ON complaints FOR ALL USING (true);
CREATE POLICY "Everyone can read announcements" ON announcements FOR SELECT USING (true);
CREATE POLICY "Only admins can create announcements" ON announcements FOR INSERT WITH CHECK (true);
CREATE POLICY "Only admins can update announcements" ON announcements FOR UPDATE USING (true);
CREATE POLICY "Only admins can manage accidents" ON accidents FOR ALL USING (true);
...
CREATE POLICY "Only admins can read activity log" ON activity_log FOR SELECT USING (true);
